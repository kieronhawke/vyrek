...
const DEFAULT_FROM = "Suth Performance Partners <onboarding@resend.dev>";
...
<div style="max-width:560px;margin:0 auto;padding:40px 24px;">
  <p style="font-family:'Geist Mono',ui-monospace,monospace;font-size:11px;letter-spacing:0.22em;text-transform:uppercase;color:${ACCENT};margin:0;">[ SUTH PERFORMANCE · PARTNERS ]</p>
  ${inner}
  <hr style="border:none;border-top:1px solid #262626;margin:32px 0;" />
  <p style="font-family:'Geist Mono',ui-monospace,monospace;font-size:10px;letter-spacing:0.22em;text-transform:uppercase;color:${DIM};margin:0;">[ SUTH PERFORMANCE · MADE IN UK ]</p>
</div>
</body></html>`;
}
...
export async function sendApprovalEmail(args: {
  ...
  const inner = `
    ...
    <p style="font-size:16px;line-height:1.6;color:${DIM};margin:0;">Your Suth Performance Partner Programme application has been approved.</p>
  ...
  return send({
    to: args.to,
    subject: "You're in. Welcome to the Suth Performance Partner Programme.",
    html: shell(inner),
  });
}
...
export async function sendMagicLinkEmail(args: {
  ...
  const inner = `
    ...
    <p style="font-size:16px;line-height:1.6;color:${DIM};margin:0;">One tap to open your Suth Performance partner dashboard. The link expires in 15 minutes.</p>
    <div style="margin-top:24px;">
  ...
  return send({
    to: args.to,
    subject: "Your Suth Performance partner dashboard link",
    html: shell(inner),
  });
}
...
export async function sendRejectionEmail(args: {
  ...
  const inner = `
    ...
    <p style="font-size:16px;line-height:1.6;color:${DIM};margin:0;">Thanks for applying to the Suth Performance Partner Programme. We are not able to take your application forward at this time.</p>
    ${reasonBlock}
  ...
  return send({
    to: args.to,
    subject: "Update on your Suth Performance Partner Programme application",
    html: shell(inner),
  });
}
...
export async function sendPayoutSentEmail(args: {
  ...
  return send({
    to: args.to,
    subject: `Suth Performance partner payout: ${amountStr} sent today`,
    html: shell(inner),
  });
}
...
export async function sendMonthlyStatementEmail(args: {
  ...
  return send({
    to: args.to,
    subject: `Suth Performance partner statement: ${args.monthLabel}`,
    html: shell(inner),
  });
}
