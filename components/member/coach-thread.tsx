  ...
  return (
    ...
    >
      ...
      <div className="ct__composer">
        ...
        {/* The standing footer, not a send confirmation. What happened to a
            message is said once, by `notice` at the top of the thread, which
            knows whether Ben was actually texted — the old "saved on this
            device, not sent" line pre-dated /api/member/coach/ask and would
            now be telling the athlete their message went nowhere. */}
