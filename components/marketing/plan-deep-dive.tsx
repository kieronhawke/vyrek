  ...
  return (
    ...
    >
      <Container>
        ...
        <div className="mx-auto mt-12 max-w-3xl overflow-hidden rounded-lg border border-suth-border-subtle bg-suth-elevated">
          <ul role="list" className="divide-y divide-suth-border-subtle">
            {EXAMPLE_WEEK.map((d) => (
              <li
                key={d.day}
              ...
              >
                ...
                <span className="text-base font-medium text-suth-text md:text-lg">
                  {d.workout}
                </span>
                <span className="hidden text-sm text-suth-text-secondary md:inline tabular-nums">
                  {d.duration}
                </span>
                <span className="text-right font-mono text-[11px] uppercase tracking-[0.18em] text-suth-text-tertiary md:text-left">
                  {d.zone}
                </span>
              </li>
            ))}
        ...
        <p className="mx-auto mt-10 max-w-2xl text-center text-base text-suth-text-secondary md:text-lg">
