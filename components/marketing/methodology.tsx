...
const PRINCIPLES = [
  {
    ...
    image: "/media/images/track/pair-elevated-colour.jpg",
    imageAlt: "Two athletes holding pace down the track straight, seen from the stands.",
  },
  {
    tag: "Calibration",
    ...
    image: "/media/images/track/gym-ergs-dark-colour.jpg",
    imageAlt: "Two athletes working on ergs in a dark gym.",
  },
  {
    tag: "Progression",
    ...
    imageAlt: "Numbered lanes on the track bend with two runners holding form.",
  },
  {
    tag: "Honesty",
    title: "No 'transformations'. Just the work.",
    body: "Suth Performance doesn't sell physique outcomes or before-and-after promises. We sell a finishing time you can put on a watch, and the structured weeks that get you there. If the programme isn't working, the Sunday recalibration changes it, or you cancel in two taps. No lock-ins, no shame.",
    image: "/media/images/track/under-stands-kit-bw.jpg",
    imageAlt: "Training kit and bike erg set up under the stadium stands.",
  },
];
      ...
      <Container>
        <header className="mx-auto max-w-2xl text-center">
          ...
          <SplitHeading
            ...
            className="mt-4 text-3xl font-black leading-[1.05] tracking-[-0.04em] text-suth-text md:text-4xl lg:text-5xl"
          >
          ...
          <p className="mt-5 text-base leading-relaxed text-suth-text-secondary md:text-lg">
            Four principles every Suth Performance programme is built on.
          </p>
        </header>
          ...
          {PRINCIPLES.map((p, i) => (
            ...
            >
              <div className="relative aspect-[16/9] overflow-hidden bg-suth-overlay">
                ...
                <span
                  aria-hidden
                  className="pointer-events-none absolute right-5 top-5 font-mono text-[11px] uppercase tracking-[0.22em] text-suth-text"
                >
                  0{i + 1}
                </span>
              </div>
              <div className="flex flex-1 flex-col gap-4 p-7 md:p-9">
                ...
                <h3 className="text-balance text-2xl font-bold leading-tight tracking-[-0.025em] text-suth-text md:text-[1.625rem]">
                  {p.title}
                </h3>
              ...
              <span
                aria-hidden
                className="pointer-events-none absolute inset-x-0 bottom-0 h-px bg-gradient-to-r from-transparent via-suth-accent/40 to-transparent opacity-0 transition-opacity duration-base group-hover:opacity-100"
              />
            </li>
          ))}
        </ol>
