...
export function PostCard({
    ...
    return (
      ...
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(60% 80% at 30% 0%, rgba(255,90,31,0.15), transparent 60%)",
          }}
        />
  ...
  if (variant === "compact") {
    return (
      ...
      >
        <div className="hidden h-16 w-20 shrink-0 overflow-hidden rounded-md bg-vyrek-overlay sm:block">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
            src={post.heroImage}
            alt={post.heroAlt}
