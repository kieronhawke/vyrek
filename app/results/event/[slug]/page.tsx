...
export async function generateMetadata({
  ...
  return {
    title: `${e.name}: ${dateRange} · Suth Performance`,
    ...
    <>
      ...
      <main className="pb-24 pt-28 md:pt-32">
        ...
        <section
          ...
          className="relative overflow-hidden border-b border-suth-border-subtle"
        >
          <div className="relative aspect-[16/9] max-h-[60vh] w-full bg-suth-elevated md:aspect-[21/9]">
            {e.heroImage ? (
              <Image
                src={e.heroImage}
                alt=""
            ...
            <div
              aria-hidden
              className="absolute inset-0 bg-gradient-to-t from-suth-base via-suth-base/60 to-suth-base/10"
            />
          </div>
          ...
          <Container className="relative -mt-32 md:-mt-44">
            <div className="mx-auto max-w-4xl">
              <Link
                href="/results/events"
                className="inline-flex items-center gap-2 font-mono text-[11px] uppercase tracking-[0.22em] text-suth-text-secondary transition-colors hover:text-suth-accent"
              >
                <span aria-hidden>←</span> All events
              </Link>
              <p className="mt-4 font-mono text-[11px] uppercase tracking-[0.22em] text-suth-accent">
                [ {statusLabel} ]
              </p>
              <h1
                id="event-heading"
              ...
              <p className="mt-4 text-base text-suth-text-secondary md:text-xl">
                {e.venue.name} · {e.venue.city}, {e.venue.country}
              </p>
              <p className="mt-2 font-mono text-sm text-suth-text-tertiary">
                {dateLabel}
              </p>
            </div>
          </Container>
        ...
        <section
          ...
          className="border-b border-suth-border-subtle py-10 md:py-14"
        >
          <Container>
        ...
        <section
          ...
          className="border-b border-suth-border-subtle py-14"
        >
          <Container>
            <div className="mx-auto max-w-4xl">
              <h2
                id="divisions-heading"
                className="text-2xl font-black tracking-[-0.04em] text-suth-text md:text-3xl"
              >
                Divisions
              </h2>
              <p className="mt-3 max-w-2xl text-base text-suth-text-secondary">
                {e.status === "finished"
              ...
              <ul role="list" className="mt-8 divide-y divide-suth-border-subtle rounded-lg border border-suth-border-subtle bg-suth-elevated">
                {e.divisions.map((div) => (
                  <li
                  ...
                  >
                    <div>
                      <p className="text-base font-bold text-suth-text md:text-lg">
                    ...
                    {div.leaderTimeSeconds ? (
                      <p className="font-mono text-base font-bold tabular-nums text-suth-accent md:text-lg">
                    ...
                    <span
                      aria-hidden
                      className="hidden font-mono text-suth-text-tertiary md:inline"
                    >
                      →
                    </span>
                  </li>
        ...
        <section className="border-b border-suth-border-subtle py-14">
          <Container>
            <div className="mx-auto max-w-4xl rounded-lg border border-suth-border-subtle bg-suth-elevated p-6 md:p-8">
              <p className="font-mono text-[10px] uppercase tracking-[0.22em] text-suth-accent">
                [ RESULTS HUB · SPRINT 2 ]
              </p>
              <h3 className="mt-3 text-xl font-bold text-suth-text md:text-2xl">
              ...
              <div className="mt-6">
                <Link
                  href="/quiz"
                  className="inline-flex h-12 items-center rounded-pill bg-suth-accent px-6 text-sm font-semibold tracking-tight text-[#0A0A0A] transition-colors hover:bg-suth-accent-hover"
                >
        ...
        {/* Data status footer */}
        <Container>
          <p className="mx-auto mt-10 max-w-4xl font-mono text-[10px] uppercase tracking-[0.22em] text-suth-text-tertiary">
...
function Stat({ label, value }: { label: string; value: string }) {
  return (
    <div className="rounded-lg border border-suth-border-subtle bg-suth-elevated p-4 md:p-5">
      <dt className="font-mono text-[10px] uppercase tracking-[0.22em] text-suth-text-tertiary">
        {label}
      </dt>
      <dd className="mt-2 text-xl font-black tabular-nums text-suth-text md:text-2xl">
        {value}
      </dd>
    </div>
  );
