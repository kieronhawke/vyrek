      ...
      <main className="pb-24 pt-28 md:pt-36">
        <Container>
          ...
          >
            ...
            <Link href="/plans" className="hover:text-suth-text">Plans</Link>
            <span aria-hidden className="mx-2">/</span>
            <span className="text-suth-text">{p.title}</span>
          </nav>
            ...
            <div className="mt-10 md:mt-0">
              ...
              <ul role="list" className="mt-4 space-y-2 text-base leading-relaxed text-suth-text-secondary">
                {p.prerequisites.map((w) => (
                  <li key={w} className="flex gap-3">
                    <span aria-hidden className="mt-2 size-1.5 shrink-0 rounded-full bg-suth-text-tertiary" />
                    <span>{w}</span>
                  </li>
                ))}
              </ul>
          ...
          <section className="mx-auto mt-16 max-w-3xl border-t border-suth-border-subtle pt-10">
            ...
            <ol role="list" className="mt-6 space-y-3">
              {p.sampleWeek.map((s, i) => (
                ...
                >
                  <span className="w-24 shrink-0 font-mono text-[11px] uppercase tracking-[0.22em] text-suth-accent">
                    {s.day}
                  </span>
                  <div>
                    <p className="text-base font-bold text-suth-text">{s.session}</p>
                    <p className="mt-1 text-sm leading-relaxed text-suth-text-secondary">{s.detail}</p>
                  </div>
                </li>
              ))}
            </ol>
            <p className="mt-6 text-sm text-suth-text-secondary">
              This is a sample. Suth Performance personalises every week to your equipment,
